# Define CIFAR-100 dataset for training
# Author: wyh
# Date: 2024.1.26
...
# define cifar100 dataset for training and give functions to make noise labels
...
class CIFAR100_Train(CIFAR100):
    ...
    def __init__(self, noise_ratio, train_root, train_indexes=None, train=True, transform=None, target_transform=None, download=False):
        super(CIFAR100_Train, self).__init__(train_root, train=train, transform=transform, target_transform=target_transform, download=download)
    ...
    def asymmetric_noise(self):
        ...
        dic = {i: (i+1)%100 for i in range(99)}
        dic[99] = 0
...
class Cifar100_Val(CIFAR100):
    def __init__(self, val_root, val_indexes, train=True, transform=None, target_transform=None, download=False):
        super(Cifar100_Val, self).__init__(val_root, train=train, transform=transform, target_transform=target_transform, download=download)
