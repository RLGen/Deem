...
def get_parser():
    ...
    parser.add_argument("--data_root", type=str, default="/data2/wyh-dataset/tabular-dataset", help="Path to the dataset root folder")
    ...
    parser.add_argument("--method", type=str, choices=["coteaching"], default="coteaching", help="Method for detecting errors")
    parser.add_argument('--result_dir', type = str, default = '/home/wangyuhui/coteaching/result', help = 'dir to save result txt files')
    ...
    parser.add_argument('--coreset_size', type=float, default=0.2)
    return parser